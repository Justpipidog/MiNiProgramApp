define(['jquery.ui'], function(ui) {
	...
	modal.navs = {
			...
			multiple: {
				...
				data: {
					C0123456789101: {
						imgurl: ASSETS+'resource/images/diypage/default/dsh.jpg',
						linkurl: '',
						text: '多商户1',
						color: '#666666',
						icon:'icon-x-shouye2'
			...
			mlist:{
				name:'多商户列表',
				icon:'iconfont2 icon-chazhaobiaodanliebiao1',
				params:{
					styledata:'0',
					repeat:'repeat',
					positionx:'left',
	...
	modal.init = function(params) {
		...
		modal.initSortable();
		modal.initGotop();
//		console.log(modal.diyform);
//		console.log(modal.companyinfo);
	...
	modal.initNavs = function() {
		...
		// }
		var navgroup = {
			0: ['listmenu', 'title2','bigimg', 'richtext','personlist','classfit', 'title', 'line', 'blank', 'menu', 'menu2', 'picture','msmk', 'banner', 'service','picturew','mlist','multiple', 'pt','dp' , 'notice','anniu','tcgg','ssk','yhq','xnlf', 'goods', 'tabbar','dnfw', 'kpgg','cases', 'joblist','xfk','logo', 'contact', 'listdesc','dt','wyrq', 'feedback', 'footmenu', 'video','yuyin']
		};
		var customPageList = [{
			'name': 'common',
			'arr': []
		...
		$.each(customPageList, function(index, item) {
			$.each(modal.navs, function(key, value) {
				var id = value.id;
				if(index === 0 && (id == 'title' || id == 'richtext' || id == 'line' || id == 'blank' || id == 'anniu' || id == 'menu' || id == 'menu2' || id == 'banner' || id == 'picture' || id == 'picturew' || id == 'title2' || id == 'bigimg' || id=="classfit")) {
					...
					customPageList[index]['arr'].push(value);
				} else if(index === 2 && (id == 'logo' || id == 'ssk' || id == 'xnlf' || id == 'dp' || id == 'xfk' || id == 'dt' || id == 'yhq' || id == 'dnfw' || id == 'yuyin' || id == 'joblist' || id == 'contact' || id == 'video' || id == 'listmenu' || id == 'service')) {
					customPageList[index]['arr'].push(value);
...
//				console.log(item,'item');
		...
		$("#saveTemp", "#saveTempModal").unbind('click').click(function() {
			...
			$.post(posturl, {
				...
				if(ret.status == 0) {
					...
					// setTimeout(function () {
					// 	window.location.href="index.php?c=site&a=entry&do=diy&op=make&m=sudu8_page&tplid="+ret.id;
     //                },2000);
				}
			}, 'json')
		})
	...
	modal.tempSet = function() {
		...
		$("#TempSet", "#TempSetModal").unbind('click').click(function() {
			...
			var temppreview = $.trim($("#TempSetModal").find("#TempSetPreview").val());
			var templateid = $("input[name='template_id']").val();
			var ids = [];
			...
			var posturl = biz.url("site/entry/Diy",'m=sudu8_page&op=make&opt=settemp')
			$.post(posturl, {
                templateid: templateid,
				name: tempname,
				preview: temppreview,
