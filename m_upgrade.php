...
`fast` int(1) NOT NULL   COMMENT '提醒发货',
...
`stat` int(1) NOT NULL   COMMENT '1 已经提醒，0未提醒',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`aboutCN` varchar(255) NOT NULL DEFAULT NULL DEFAULT '门店介绍',
`aboutCNen` varchar(255) NOT NULL DEFAULT NULL DEFAULT 'About Store',
...
`tabbar_time` int(11),
`config` varchar(1000),
`tabbar_t` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
`hxmm` varchar(255)  DEFAULT NULL DEFAULT 'hx123456',
`logo2` varchar(255),
`sharejf` varchar(255) NOT NULL DEFAULT NULL DEFAULT '10',
`sharetype` int(1) NOT NULL DEFAULT NULL DEFAULT '3',
`sharexz` int(11) NOT NULL DEFAULT NULL DEFAULT '10',
`spcatename` varchar(255),
`spcatenameen` varchar(255),
`sp_i_b_y_ts` int(1) NOT NULL,
`sptj_max` int(11) NOT NULL DEFAULT NULL DEFAULT '10',
`sptj_max_sp` int(11) NOT NULL DEFAULT NULL DEFAULT '10',
`gonggao` varchar(255),
`gonggaoUrl` varchar(255),
`homepage` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1默认首页 2diy首页',
...
`pic_page_bg` int(1) NOT NULL,
`list_style_more` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
`slide_is` int(1) NOT NULL DEFAULT NULL DEFAULT '2',
...
`uniacid` int(11) NOT NULL,
`flag` int(1)    COMMENT '0未审  1通过  2不通过',
...
`id` int(11) NOT NULL  AUTO_INCREMENT,
`num` int(11) NOT NULL   COMMENT '序号排序',
`title` varchar(255),
`uniacid` int(11) NOT NULL   COMMENT '小程序ID',
`price` varchar(255) NOT NULL   COMMENT '优惠价格',
`pay_money` varchar(255) NOT NULL   COMMENT '使用条件价格',
`btime` int(11) NOT NULL   COMMENT '使用开始日期',
`etime` int(11) NOT NULL   COMMENT '优惠券结束日期',
`counts` int(11) NOT NULL DEFAULT NULL DEFAULT '-1'  COMMENT '优惠券总数',
`xz_count` int(11) NOT NULL   COMMENT '每人限制领取数',
`creattime` int(11) NOT NULL   COMMENT '优惠券创建时间',
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '0关闭   1开启',
`color` char(10) NOT NULL DEFAULT NULL DEFAULT '#ff6600',
`nownum` int(11),
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11) NOT NULL,
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`ltime` int(11)    COMMENT '领取时间',
`utime` int(11)    COMMENT '使用时间',
`btime` int(11)    COMMENT '开始时间',
`etime` int(11)    COMMENT '结束时间',
`flag` int(11) NOT NULL   COMMENT '0未使用1已使用2已过期',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS `ims_sudu8_page_diypage` (
`id` int(11) NOT NULL  AUTO_INCREMENT,
`index` int(1) NOT NULL   COMMENT '是否首页',
...
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11) NOT NULL,
`go_home` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1倒计时 2按钮',
...
`foot_is` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1默认 2diy底部',
`pid` int(11),
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`status` int(1)  DEFAULT NULL DEFAULT '2',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`type_x` int(1) NOT NULL,
`type_y` int(1) NOT NULL,
...
`texts` text() NOT NULL,
`types` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1不启用规格 2启用规格',
`explains` varchar(255) NOT NULL   COMMENT '说明',
`score` varchar(255) NOT NULL,
`xsl` int(11) NOT NULL   COMMENT '销售量',
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`is_mo` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
...
`creattime` int(11) NOT NULL,
`hxtime` int(11) NOT NULL,
`nav` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1发货  2自提',
`kuadi` varchar(255) NOT NULL,
`kuaidihao` varchar(255) NOT NULL,
`flag` int(1) NOT NULL   COMMENT '0未支付1已支付2已结算3已过期',
...
`status` int(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '1开启  2不开启',
...
`usname` int(1) NOT NULL,
`ustel` int(1) NOT NULL,
`usadd` int(1) NOT NULL,
`usdate` int(1) NOT NULL,
`ustime` int(1) NOT NULL,
...
`uid` int(11) NOT NULL,
`uniacid` int(11) NOT NULL,
`collection` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1',
...
`num` int(11) NOT NULL DEFAULT NULL DEFAULT '1',
`status` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1启用 2不启用',
`createtime` datetime() NOT NULL,
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`uid` int(11) NOT NULL,
`uniacid` int(11) NOT NULL,
`likes` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1点赞 2不点赞',
`rid` int(11) NOT NULL   COMMENT 'release表id',
`createtime` datetime() NOT NULL,
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`openid` varchar(255) NOT NULL,
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '1已支付  2未支付',
`createtime` datetime() NOT NULL,
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`hot` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '是否推荐（1推荐 2不推荐）',
...
`address` varchar(255) NOT NULL,
`stick` int(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '1置顶 2不置顶',
`createtime` datetime() NOT NULL,
...
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11) NOT NULL,
`release_money` decimal(5,2) NOT NULL DEFAULT NULL DEFAULT '0.00',
`stick_money` decimal(5,2) NOT NULL DEFAULT NULL DEFAULT '10.00',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11) NOT NULL,
`fx_cj` int(1) NOT NULL DEFAULT NULL DEFAULT '4'  COMMENT '1一级2二级3三级4不启用',
`sxj_gx` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1点击分享2首次下单3首次付款',
`fxs_sz` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1无条件2申请3消费次数4消费金额5购买商品',
`fxs_sz_val` varchar(255) NOT NULL   COMMENT '分销商规则值',
`fxs_xy` text() NOT NULL,
`one_bili` int(11) NOT NULL   COMMENT '一级比例',
`two_bili` int(11) NOT NULL   COMMENT '二级比例',
`three_bili` int(11) NOT NULL   COMMENT '三级比例',
`txmoney` float() NOT NULL DEFAULT NULL DEFAULT '10',
...
`miaos` int(11) NOT NULL DEFAULT NULL DEFAULT '5',
`fx_name` varchar(255) NOT NULL DEFAULT NULL DEFAULT '分销商',
`sq_thumb` varchar(255) NOT NULL,
`fxs_name` varchar(255) NOT NULL DEFAULT NULL DEFAULT '分销商',
`tx_type` varchar(32)  DEFAULT NULL DEFAULT '1,2,3',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`creattime` int(11) NOT NULL,
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1待分成2已分成3取消分成',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`creattime` int(11) NOT NULL,
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1申请中2已通过3不通过',
`formid` varchar(255),
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`creattime` int(11) NOT NULL,
`types` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1余额2微信3支付宝',
`zfbzh` varchar(255) NOT NULL,
`zfbxm` varchar(255) NOT NULL,
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1申请中2已通过3已拒绝',
...
`participate` int(11) NOT NULL   COMMENT '参与人数',
`win` int(11) NOT NULL   COMMENT '获奖人数',
`browse` int(11) NOT NULL   COMMENT '浏览量',
`share` int(11) NOT NULL   COMMENT '分享量',
...
`opt` varchar(32) NOT NULL DEFAULT NULL DEFAULT 'wb-display',
`icon` varchar(32) NOT NULL DEFAULT NULL DEFAULT 'wb-dashboard',
`type` int(1) NOT NULL   COMMENT '节点还是栏目',
`stat` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '是否显示',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`statue` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '多栏目状态',
`list_style` int(2) NOT NULL   COMMENT '列表样式',
`list_stylet` char(10) NOT NULL   COMMENT '列表样式里的标题样式',
`top_catas` varchar(255) NOT NULL,
`psize` int(11)  DEFAULT NULL DEFAULT '10',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS `ims_sudu8_page_multicates` (
`id` int(11) NOT NULL  AUTO_INCREMENT,
`sort` int(5) NOT NULL DEFAULT NULL DEFAULT '1',
`status` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
...
`overtime` int(11),
`reback` int(11) NOT NULL,
`is_more` int(1) NOT NULL,
`coupon` int(11),
`order_duo` text(),
`pro_user_add` varchar(100),
`beizhu_val` text(),
`pay_price` float() NOT NULL,
`dkscore` float() NOT NULL,
`nav` int(1) NOT NULL,
`address` int(11) NOT NULL,
`formid` int(11),
`prepayid` varchar(255),
...
`uniacid` int(11) NOT NULL,
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1开启 2不开启',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`product_txt` text(),
`pro_flag` int(11),
`pro_kc` int(11) NOT NULL DEFAULT NULL DEFAULT '-1',
`pro_xz` int(11) NOT NULL,
`sale_tnum` int(11) NOT NULL,
`sale_type` int(11)  DEFAULT NULL DEFAULT '1',
`sale_time` int(11),
`labels` varchar(255),
`pro_flag_tel` int(1) NOT NULL,
...
`pro_flag_add` int(1),
`formset` int(20) NOT NULL,
`is_score` int(1) NOT NULL,
`score_num` int(11) NOT NULL,
`con2` varchar(5000) NOT NULL,
`con3` varchar(5000) NOT NULL,
`share_type` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1个人2仅群3个人加群',
`share_score` varchar(255) NOT NULL   COMMENT '分享积分',
`share_num` int(11) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '分享限制次数',
`share_gz` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1公共规则2自身规则',
`comment` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '评论功能 1开启 2不开启',
`multi` int(1) NOT NULL,
`top_catas` varchar(255) NOT NULL,
`sons_catas` varchar(255) NOT NULL,
`mulitcataid` int(5) NOT NULL,
`get_share_gz` int(1) NOT NULL DEFAULT NULL DEFAULT '2',
`get_share_score` int(11) NOT NULL,
` get_share_num` int(11) NOT NULL,
`get_share_num` int(11) NOT NULL,
`shareimg` varchar(255),
`glnews` varchar(2000),
`kuaidi` int(1),
`sale_end_time` int(11),
`scoreback` varchar(20),
`fx_uni` int(1),
...
`uniacid` int(11) NOT NULL,
`id` int(11) NOT NULL  AUTO_INCREMENT,
`types` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
`is_score` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1不启用 2启用【启用积分抵扣】',
`is_tuanz` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1不启用2启用【启用团长优惠】',
`is_pt` int(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '1不启用2启用【是否自动成团】',
`pt_time` int(11) NOT NULL DEFAULT NULL DEFAULT '24'  COMMENT '成团时间',
`fahuo` int(11) NOT NULL DEFAULT NULL DEFAULT '7'  COMMENT '自动发货',
`guiz` text() NOT NULL,
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`creattime` int(11) NOT NULL,
`hxtime` int(11) NOT NULL,
`nav` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
`kuadi` varchar(255) NOT NULL,
`kuaidihao` varchar(255) NOT NULL,
`flag` int(1) NOT NULL,
`types` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1拼团2立即购买',
`pt_order` varchar(255) NOT NULL   COMMENT '拼团的订单id',
`ck` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1开团2参团',
`jqr` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1买家2机器人',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`type_i` int(1) NOT NULL,
`title` varchar(255) NOT NULL,
`price` float() NOT NULL   COMMENT '拼团价[显示用，一般设置最低]',
`mark_price` float() NOT NULL   COMMENT '单买价[显示用]',
`thumb` varchar(255) NOT NULL   COMMENT '缩略图',
`imgtext` varchar(2000) NOT NULL   COMMENT '组图',
`descs` varchar(1000) NOT NULL   COMMENT '简介',
`texts` text() NOT NULL   COMMENT '详情',
`types` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '拼团类型1单层团2阶梯团',
`explains` varchar(255) NOT NULL   COMMENT '标签',
`pt_min` int(11) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '拼团最小人数',
`pt_max` int(11) NOT NULL DEFAULT NULL DEFAULT '5'  COMMENT '拼团最大人数',
`score` int(11) NOT NULL   COMMENT '最多可抵用积分',
`xsl` int(11) NOT NULL,
`tz_yh` int(11) NOT NULL DEFAULT NULL DEFAULT '10',
`kuaidi` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
`shareimg` varchar(255),
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`creattime` int(11) NOT NULL,
`join_count` int(11) NOT NULL DEFAULT NULL DEFAULT '1',
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1正在进行2已完成3已过期',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`getmoney` varchar(255) NOT NULL,
`getscore` varchar(255) NOT NULL,
`getcoupon` int(11) NOT NULL,
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS `ims_sudu8_page_rechargeconf` (
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11) NOT NULL,
`scroe` varchar(255) NOT NULL DEFAULT NULL DEFAULT '100',
`money` varchar(255) NOT NULL DEFAULT NULL DEFAULT '1',
`title` varchar(50) NOT NULL DEFAULT NULL DEFAULT '充值有礼',
`score_shoppay` int(11) NOT NULL   COMMENT '店内最大抵扣积分',
`copyright_appid` varchar(255),
`copyright_page` varchar(255),
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`score` float() NOT NULL   COMMENT '积分数',
...
`buy_type` varchar(255) NOT NULL DEFAULT NULL DEFAULT '兑换',
`thumb` varchar(255) NOT NULL,
`text` text() NOT NULL,
...
`flag` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`buy_type` int(1) NOT NULL   COMMENT '0购买1预定',
`hot` int(1) NOT NULL   COMMENT '0不推荐1推荐',
`pageview` int(11) NOT NULL   COMMENT '访问量',
`vsales` int(11) NOT NULL   COMMENT '虚拟销量',
`rsales` int(11) NOT NULL   COMMENT '真实销量',
`sellprice` float(10,2) NOT NULL DEFAULT NULL DEFAULT '0.00'  COMMENT '售价',
`marketprice` float(10,2) NOT NULL DEFAULT NULL DEFAULT '0.00'  COMMENT '市场价',
`storage` int(11) NOT NULL   COMMENT '库存量',
`thumb` varchar(1000)    COMMENT '缩略图',
`images` varchar(5000)    COMMENT '产品组图',
`descp` varchar(2000)    COMMENT '产品详情',
`num` int(11) NOT NULL   COMMENT '排序越大越靠前',
`createtime` int(11) NOT NULL   COMMENT '创建日期',
`flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '0下架1上架',
`status` int(1) NOT NULL   COMMENT '0未审核1已审核',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS `ims_sudu8_page_shops_set` (
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11) NOT NULL,
`apply` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '0不需要审核1需要',
`goods` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '商品0不需审核1需要',
`withdraw` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '提现0不需要审核1需要',
`minimum` float(10,2) NOT NULL DEFAULT NULL DEFAULT '0.00'  COMMENT '最低提现金额',
`bg` varchar(255)    COMMENT '商户申请入驻页头部背景图',
`protocol` varchar(5000)    COMMENT '商户入驻协议',
`tjnum` int(11) NOT NULL DEFAULT NULL DEFAULT '6'  COMMENT '推荐数',
`num` int(11) NOT NULL DEFAULT NULL DEFAULT '6'  COMMENT '默认数',
PRIMARY KEY (`id`)
...
`username` varchar(50) NOT NULL DEFAULT NULL DEFAULT 'admin'  COMMENT '登录名',
`password` varchar(50) NOT NULL DEFAULT NULL DEFAULT '12345'  COMMENT '密码',
`tixian` float(10,2) NOT NULL DEFAULT NULL DEFAULT '0.00'  COMMENT '可提现金额',
...
`flag` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '状态0下架1上架',
`hot` tinyint(1) NOT NULL   COMMENT '0不推荐，1推荐',
`authenticate` tinyint(1) NOT NULL   COMMENT '是否已认证0否1是',
...
`flag` int(1) NOT NULL   COMMENT '0申请中1已通过2已拒绝',
`createtime` int(11) NOT NULL   COMMENT '创建时间',
...
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11) NOT NULL,
`score` varchar(20) NOT NULL DEFAULT NULL DEFAULT '10/20',
`max_score` int(11) NOT NULL DEFAULT NULL DEFAULT '100000',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`wxnumber` varchar(100)    COMMENT '微信号码',
`email` varchar(50) NOT NULL   COMMENT '邮箱',
`province` varchar(100)    COMMENT '所属省',
`proid` int(10) NOT NULL,
`city` varchar(100)    COMMENT '所属城市',
`cityid` int(10) NOT NULL,
`area` varchar(100)    COMMENT '所属区/市/县',
`areaid` int(10) NOT NULL,
`address` varchar(100)    COMMENT '详细地址',
`title` varchar(50)    COMMENT '头衔',
`job` varchar(50)    COMMENT '职务',
`pic` varchar(255)    COMMENT '照片',
`contract` int(10)    COMMENT '签约状态 0-未签约  1-已签约  2-待续约',
`auth` int(10)    COMMENT '认证状态  0-待认证, 1-已认证',
`score` float(2,1)  DEFAULT NULL DEFAULT '0.0'  COMMENT '评分  0-5星',
`visit` int(10)    COMMENT '访问量',
`zan` int(10)    COMMENT '点赞量',
`forward` int(10)    COMMENT '转发量',
`expand` varchar(255)    COMMENT '拓展内容',
`price` int(10)    COMMENT '工时费',
`descp` text()    COMMENT '介绍',
`voice` varchar(255)    COMMENT '音频介绍',
`autovoice` int(10) NOT NULL   COMMENT '是否自动播放语音',
`qrcode` varchar(255)    COMMENT '生成的二维码图片',
`bqrcode` varchar(255)    COMMENT '后台生成二维码',
`company` varchar(255)    COMMENT '所属公司',
`visitor` varchar(255),
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS `ims_sudu8_page_staff_record` (
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11)    COMMENT '小程序ID',
`operid` int(11)    COMMENT '操作人ID',
`readid` int(11)    COMMENT '查看人ID',
`staffid` int(11)    COMMENT '员工ID',
`type` varchar(50)    COMMENT '类型 分享还是保存',
`score` int(10) NOT NULL   COMMENT '积分',
`prize` int(10) NOT NULL   COMMENT '抽奖次数',
`createtime` int(11) NOT NULL   COMMENT '操作时间',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS `ims_sudu8_page_staff_zans` (
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uid` int(11) NOT NULL,
`uniacid` int(11) NOT NULL,
`zans` int(10) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1点赞 0不点赞',
`sid` int(11) NOT NULL   COMMENT '员工id',
`createtime` int(11) NOT NULL,
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS `ims_sudu8_page_staffset` (
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11)    COMMENT '小程序ID',
`list_style` int(2) NOT NULL   COMMENT '员工列表样式',
`card_style` int(2) NOT NULL   COMMENT '名片样式',
`is_share` int(2) NOT NULL   COMMENT '是否开启分享名片规则',
`share_score` int(10) NOT NULL   COMMENT '分享一次积分',
`share_scount` int(10) NOT NULL   COMMENT '每天分享获得积分上限',
`share_prize` int(10) NOT NULL   COMMENT '分享一次抽奖次数',
`share_pcount` int(10) NOT NULL   COMMENT '每天分享获得抽奖上限',
`is_save` int(2) NOT NULL   COMMENT '是否开启保存名片规则',
`save_score` int(10) NOT NULL   COMMENT '保存一次积分',
`save_scount` int(10) NOT NULL   COMMENT '每天保存获得积分上限',
`save_prize` int(10) NOT NULL   COMMENT '保存一次抽奖次数',
`save_pcount` int(10) NOT NULL   COMMENT '每天保存获得抽奖上限',
`tabbar_t` int(2) NOT NULL   COMMENT '是否开启底部菜单',
`tabbar_bg` varchar(50)    COMMENT '菜单栏背景色',
`color_bar` varchar(50)    COMMENT '菜单栏横线颜色',
`tabbar_tc` varchar(50)    COMMENT '菜单栏文字颜色',
`tabbar_tca` varchar(50)    COMMENT '选中文字颜色',
`tabbar` text()    COMMENT '底部菜单配置',
`tabnum` int(2)    COMMENT '底部菜单数量',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`title` varchar(255) NOT NULL DEFAULT NULL DEFAULT '门店',
PRIMARY KEY (``)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`gender` tinyint(1)    COMMENT '性别(0:保密 1:男 2:女)',
...
`flag` int(11) NOT NULL,
`p_p_parent_id` varchar(1000) NOT NULL   COMMENT '父级的父级的父级',
`p_parent_id` varchar(1000) NOT NULL   COMMENT '父级的父级',
`parent_id` varchar(1000) NOT NULL   COMMENT '父级',
`fxs` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1不是分销商2分销商',
`fxstime` int(11) NOT NULL,
`fx_allmoney` float() NOT NULL   COMMENT '分销获得过的钱',
`fx_getmoney` float() NOT NULL   COMMENT '分销已经提现的钱',
`fx_money` float() NOT NULL   COMMENT '分销商获得过的钱分销可提现钱',
`p_get_money` float() NOT NULL   COMMENT '父级获得的钱',
`p_p_get_money` float() NOT NULL   COMMENT '父父级获得的钱',
`p_p_p_get_money` float() NOT NULL   COMMENT '父父父级获得的钱',
...
CREATE TABLE IF NOT EXISTS `ims_sudu8_page_usergroup` (
`id` int(11) NOT NULL  AUTO_INCREMENT,
`name` varchar(255) NOT NULL,
`uniacid` int(11) NOT NULL,
...
`creattime` int(11) NOT NULL,
`type` int(1) NOT NULL DEFAULT NULL DEFAULT '1',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
`fid` int(11) NOT NULL   COMMENT '提交表单信息id',
`formid` varchar(255) NOT NULL   COMMENT '模板消息formid',
`flag` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '3'  COMMENT '3未审核 1通过  2不通过',
...
`id` int(11) NOT NULL  AUTO_INCREMENT,
`uniacid` int(11) NOT NULL,
`isopen` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '会员卡0不开启1开启2强制开启',
`name` varchar(255) NOT NULL DEFAULT NULL DEFAULT '会员卡'  COMMENT '会员卡名称',
`recharge` tinyint(1) NOT NULL   COMMENT '充值0直接可用1开卡后可用',
`coupon` tinyint(1) NOT NULL   COMMENT '领优惠券0直接可用1开卡后可用',
`sign` tinyint(1) NOT NULL   COMMENT '积分签到0直接可用1开卡后可用',
`exchange` tinyint(1) NOT NULL   COMMENT '积分兑换0直接可用1开卡后可用',
`formid` int(11),
`shenhe` int(1)  DEFAULT NULL DEFAULT '2',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
if(pdo_tableexists('sudu8_page_about')) {
 if(!pdo_fieldexists('sudu8_page_about',  'uniacid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_about')." ADD `uniacid` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_about')) {
...
if(pdo_tableexists('sudu8_page_art_navlist')) {
 if(!pdo_fieldexists('sudu8_page_art_navlist',  'textcolor')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_art_navlist')." ADD `textcolor` varchar(255);");
 }
}
...
if(pdo_tableexists('sudu8_page_auction_goodslist')) {
 if(!pdo_fieldexists('sudu8_page_auction_goodslist',  'bond')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_auction_goodslist')." ADD `bond` float()    COMMENT '保证金';");
 }
}
if(pdo_tableexists('sudu8_page_auction_goodslist')) {
...
if(pdo_tableexists('sudu8_page_auction_goodslist')) {
 if(!pdo_fieldexists('sudu8_page_auction_goodslist',  'stat')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_auction_goodslist')." ADD `stat` int(1)  DEFAULT NULL DEFAULT '1'  COMMENT '状态， 0 下架 1上架 2 完成 3 流拍';");
 }
}
if(pdo_tableexists('sudu8_page_auction_goodslist')) {
 if(!pdo_fieldexists('sudu8_page_auction_goodslist',  'max_cost')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_auction_goodslist')." ADD `max_cost` float()    COMMENT '最高出价';");
 }
}
if(pdo_tableexists('sudu8_page_auction_goodslist')) {
...
if(pdo_tableexists('sudu8_page_auction_goodslist')) {
 if(!pdo_fieldexists('sudu8_page_auction_goodslist',  'flow')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_auction_goodslist')." ADD `flow` int(11)    COMMENT '围观人数';");
 }
}
if(pdo_tableexists('sudu8_page_auction_goodslist')) {
...
if(pdo_tableexists('sudu8_page_auction_goodslist')) {
 if(!pdo_fieldexists('sudu8_page_auction_goodslist',  'isindex')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_auction_goodslist')." ADD `isindex` int(1) NOT NULL;");
 }
}
...
if(pdo_tableexists('sudu8_page_auction_order')) {
 if(!pdo_fieldexists('sudu8_page_auction_order',  'fast')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_auction_order')." ADD `fast` int(1) NOT NULL   COMMENT '提醒发货';");
 }
}
if(pdo_tableexists('sudu8_page_auction_order')) {
...
if(pdo_tableexists('sudu8_page_auction_remind')) {
 if(!pdo_fieldexists('sudu8_page_auction_remind',  'stat')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_auction_remind')." ADD `stat` int(1) NOT NULL   COMMENT '1 已经提醒，0未提醒';");
 }
}
...
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'aboutCN')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `aboutCN` varchar(255) NOT NULL DEFAULT NULL DEFAULT '门店介绍';");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'aboutCNen')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `aboutCNen` varchar(255) NOT NULL DEFAULT NULL DEFAULT 'About Store';");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
...
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'tabbar_t')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `tabbar_t` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
...
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'sharejf')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `sharejf` varchar(255) NOT NULL DEFAULT NULL DEFAULT '10';");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'sharetype')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `sharetype` int(1) NOT NULL DEFAULT NULL DEFAULT '3';");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'sharexz')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `sharexz` int(11) NOT NULL DEFAULT NULL DEFAULT '10';");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
...
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'sp_i_b_y_ts')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `sp_i_b_y_ts` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'sptj_max')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `sptj_max` int(11) NOT NULL DEFAULT NULL DEFAULT '10';");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'sptj_max_sp')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `sptj_max_sp` int(11) NOT NULL DEFAULT NULL DEFAULT '10';");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
...
if(pdo_tableexists('sudu8_page_base')) {
 if(!pdo_fieldexists('sudu8_page_base',  'homepage')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_base')." ADD `homepage` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1默认首页 2diy首页';");
 }
}
if(pdo_tableexists('sudu8_page_base')) {
...
if(pdo_tableexists('sudu8_page_cate')) {
 if(!pdo_fieldexists('sudu8_page_cate',  'pic_page_btn')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_cate')." ADD `pic_page_btn` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_cate')) {
...
if(pdo_tableexists('sudu8_page_cate')) {
 if(!pdo_fieldexists('sudu8_page_cate',  'pic_page_bg')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_cate')." ADD `pic_page_bg` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_cate')) {
 if(!pdo_fieldexists('sudu8_page_cate',  'list_style_more')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_cate')." ADD `list_style_more` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_cate')) {
 if(!pdo_fieldexists('sudu8_page_cate',  'slide_is')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_cate')." ADD `slide_is` int(1) NOT NULL DEFAULT NULL DEFAULT '2';");
 }
}
if(pdo_tableexists('sudu8_page_cate')) {
...
if(pdo_tableexists('sudu8_page_comment')) {
 if(!pdo_fieldexists('sudu8_page_comment',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_comment')." ADD `flag` int(1)    COMMENT '0未审  1通过  2不通过';");
 }
}
if(pdo_tableexists('sudu8_page_comment')) {
...
if(pdo_tableexists('sudu8_page_comment')) {
 if(!pdo_fieldexists('sudu8_page_comment',  'follow')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_comment')." ADD `follow` int(11);");
 }
}
...
if(pdo_tableexists('sudu8_page_coupon')) {
 if(!pdo_fieldexists('sudu8_page_coupon',  'num')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon')." ADD `num` int(11) NOT NULL   COMMENT '序号排序';");
 }
}
if(pdo_tableexists('sudu8_page_coupon')) {
...
if(pdo_tableexists('sudu8_page_coupon')) {
 if(!pdo_fieldexists('sudu8_page_coupon',  'price')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon')." ADD `price` varchar(255) NOT NULL   COMMENT '优惠价格';");
 }
}
if(pdo_tableexists('sudu8_page_coupon')) {
 if(!pdo_fieldexists('sudu8_page_coupon',  'pay_money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon')." ADD `pay_money` varchar(255) NOT NULL   COMMENT '使用条件价格';");
 }
}
if(pdo_tableexists('sudu8_page_coupon')) {
 if(!pdo_fieldexists('sudu8_page_coupon',  'btime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon')." ADD `btime` int(11) NOT NULL   COMMENT '使用开始日期';");
 }
}
if(pdo_tableexists('sudu8_page_coupon')) {
 if(!pdo_fieldexists('sudu8_page_coupon',  'etime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon')." ADD `etime` int(11) NOT NULL   COMMENT '优惠券结束日期';");
 }
}
if(pdo_tableexists('sudu8_page_coupon')) {
 if(!pdo_fieldexists('sudu8_page_coupon',  'counts')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon')." ADD `counts` int(11) NOT NULL DEFAULT NULL DEFAULT '-1'  COMMENT '优惠券总数';");
 }
}
if(pdo_tableexists('sudu8_page_coupon')) {
 if(!pdo_fieldexists('sudu8_page_coupon',  'xz_count')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon')." ADD `xz_count` int(11) NOT NULL   COMMENT '每人限制领取数';");
 }
}
if(pdo_tableexists('sudu8_page_coupon')) {
...
if(pdo_tableexists('sudu8_page_coupon')) {
 if(!pdo_fieldexists('sudu8_page_coupon',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '0关闭   1开启';");
 }
}
if(pdo_tableexists('sudu8_page_coupon')) {
 if(!pdo_fieldexists('sudu8_page_coupon',  'color')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon')." ADD `color` char(10) NOT NULL DEFAULT NULL DEFAULT '#ff6600';");
 }
}
if(pdo_tableexists('sudu8_page_coupon')) {
...
if(pdo_tableexists('sudu8_page_coupon_set')) {
 if(!pdo_fieldexists('sudu8_page_coupon_set',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon_set')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
...
if(pdo_tableexists('sudu8_page_coupon_user')) {
 if(!pdo_fieldexists('sudu8_page_coupon_user',  'ltime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon_user')." ADD `ltime` int(11)    COMMENT '领取时间';");
 }
}
if(pdo_tableexists('sudu8_page_coupon_user')) {
 if(!pdo_fieldexists('sudu8_page_coupon_user',  'utime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon_user')." ADD `utime` int(11)    COMMENT '使用时间';");
 }
}
if(pdo_tableexists('sudu8_page_coupon_user')) {
 if(!pdo_fieldexists('sudu8_page_coupon_user',  'btime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon_user')." ADD `btime` int(11)    COMMENT '开始时间';");
 }
}
if(pdo_tableexists('sudu8_page_coupon_user')) {
 if(!pdo_fieldexists('sudu8_page_coupon_user',  'etime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon_user')." ADD `etime` int(11)    COMMENT '结束时间';");
 }
}
if(pdo_tableexists('sudu8_page_coupon_user')) {
 if(!pdo_fieldexists('sudu8_page_coupon_user',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_coupon_user')." ADD `flag` int(11) NOT NULL   COMMENT '0未使用1已使用2已过期';");
 }
}
...
if(pdo_tableexists('sudu8_page_diypage')) {
 if(!pdo_fieldexists('sudu8_page_diypage',  'index')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_diypage')." ADD `index` int(1) NOT NULL   COMMENT '是否首页';");
 }
}
if(pdo_tableexists('sudu8_page_diypage')) {
...
if(pdo_tableexists('sudu8_page_diypage_sys')) {
 if(!pdo_fieldexists('sudu8_page_diypage_sys',  'index')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_diypage_sys')." ADD `index` int(1) NOT NULL   COMMENT '是否首页';");
 }
}
if(pdo_tableexists('sudu8_page_diypage_sys')) {
...
if(pdo_tableexists('sudu8_page_diypageset')) {
 if(!pdo_fieldexists('sudu8_page_diypageset',  'go_home')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_diypageset')." ADD `go_home` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1倒计时 2按钮';");
 }
}
if(pdo_tableexists('sudu8_page_diypageset')) {
...
if(pdo_tableexists('sudu8_page_diypageset')) {
 if(!pdo_fieldexists('sudu8_page_diypageset',  'foot_is')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_diypageset')." ADD `foot_is` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1默认 2diy底部';");
 }
}
if(pdo_tableexists('sudu8_page_diypageset')) {
 if(!pdo_fieldexists('sudu8_page_diypageset',  'pid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_diypageset')." ADD `pid` int(11);");
 }
}
...
if(pdo_tableexists('sudu8_page_diypagetpl')) {
 if(!pdo_fieldexists('sudu8_page_diypagetpl',  'pageid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_diypagetpl')." ADD `pageid` varchar(1000) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_diypagetpl')) {
...
if(pdo_tableexists('sudu8_page_diypagetpl')) {
 if(!pdo_fieldexists('sudu8_page_diypagetpl',  'status')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_diypagetpl')." ADD `status` int(1)  DEFAULT NULL DEFAULT '2';");
 }
}
...
if(pdo_tableexists('sudu8_page_diypagetpl_sys')) {
 if(!pdo_fieldexists('sudu8_page_diypagetpl_sys',  'pageid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_diypagetpl_sys')." ADD `pageid` varchar(1000) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_diypagetpl_sys')) {
...
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'cid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `cid` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'pcid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `pcid` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'type_x')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `type_x` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'type_y')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `type_y` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'type_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `type_i` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
...
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'price')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `price` float() NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'mark_price')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `mark_price` float() NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
...
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'types')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `types` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1不启用规格 2启用规格';");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
...
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `score` varchar(255) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'xsl')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `xsl` int(11) NOT NULL   COMMENT '销售量';");
 }
}
if(pdo_tableexists('sudu8_page_duo_products')) {
 if(!pdo_fieldexists('sudu8_page_duo_products',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
...
if(pdo_tableexists('sudu8_page_duo_products_address')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_address',  'is_mo')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_address')." ADD `is_mo` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_address')) {
...
if(pdo_tableexists('sudu8_page_duo_products_gwc')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_gwc',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_gwc')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
...
if(pdo_tableexists('sudu8_page_duo_products_order')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_order',  'coupon')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_order')." ADD `coupon` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_order')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_order',  'jf')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_order')." ADD `jf` varchar(255) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_order')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_order',  'address')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_order')." ADD `address` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_order')) {
...
if(pdo_tableexists('sudu8_page_duo_products_order')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_order',  'hxtime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_order')." ADD `hxtime` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_order')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_order',  'nav')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_order')." ADD `nav` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1发货  2自提';");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_order')) {
...
if(pdo_tableexists('sudu8_page_duo_products_order')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_order',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_order')." ADD `flag` int(1) NOT NULL   COMMENT '0未支付1已支付2已结算3已过期';");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_order')) {
...
if(pdo_tableexists('sudu8_page_duo_products_order')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_order',  'sid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_order')." ADD `sid` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_order')) {
...
if(pdo_tableexists('sudu8_page_duo_products_order')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_order',  'qx_formid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_order')." ADD `qx_formid` varchar(255);");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_order')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_order',  'yhInfo')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_order')." ADD `yhInfo` varchar(255);");
 }
}
...
if(pdo_tableexists('sudu8_page_duo_products_type_value')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_type_value',  'salenum')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_type_value')." ADD `salenum` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_duo_products_type_value')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_type_value',  'vsalenum')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_type_value')." ADD `vsalenum` int(11);");
 }
}
...
if(pdo_tableexists('sudu8_page_duo_products_yunfei')) {
 if(!pdo_fieldexists('sudu8_page_duo_products_yunfei',  'formset')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_duo_products_yunfei')." ADD `formset` int(11) NOT NULL;");
 }
}
...
if(pdo_tableexists('sudu8_page_food')) {
 if(!pdo_fieldexists('sudu8_page_food',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_food')) {
...
if(pdo_tableexists('sudu8_page_food_cate')) {
 if(!pdo_fieldexists('sudu8_page_food_cate',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food_cate')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
...
if(pdo_tableexists('sudu8_page_food_order')) {
 if(!pdo_fieldexists('sudu8_page_food_order',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food_order')." ADD `flag` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_food_order')) {
...
if(pdo_tableexists('sudu8_page_food_printer')) {
 if(!pdo_fieldexists('sudu8_page_food_printer',  'status')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food_printer')." ADD `status` int(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '1开启  2不开启';");
 }
}
if(pdo_tableexists('sudu8_page_food_printer')) {
...
if(pdo_tableexists('sudu8_page_food_sj')) {
 if(!pdo_fieldexists('sudu8_page_food_sj',  'usname')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food_sj')." ADD `usname` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_food_sj')) {
 if(!pdo_fieldexists('sudu8_page_food_sj',  'ustel')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food_sj')." ADD `ustel` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_food_sj')) {
 if(!pdo_fieldexists('sudu8_page_food_sj',  'usadd')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food_sj')." ADD `usadd` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_food_sj')) {
 if(!pdo_fieldexists('sudu8_page_food_sj',  'usdate')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food_sj')." ADD `usdate` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_food_sj')) {
 if(!pdo_fieldexists('sudu8_page_food_sj',  'ustime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food_sj')." ADD `ustime` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_food_sj')) {
 if(!pdo_fieldexists('sudu8_page_food_sj',  'score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_food_sj')." ADD `score` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_food_sj')) {
...
if(pdo_tableexists('sudu8_page_formcon')) {
 if(!pdo_fieldexists('sudu8_page_formcon',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_formcon')." ADD `flag` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_formcon')) {
...
if(pdo_tableexists('sudu8_page_formcon')) {
 if(!pdo_fieldexists('sudu8_page_formcon',  'fid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_formcon')." ADD `fid` int(11);");
 }
}
...
if(pdo_tableexists('sudu8_page_forms')) {
 if(!pdo_fieldexists('sudu8_page_forms',  'status')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forms')." ADD `status` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_forms')) {
...
if(pdo_tableexists('sudu8_page_forms_config')) {
 if(!pdo_fieldexists('sudu8_page_forms_config',  'tel_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forms_config')." ADD `tel_i` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_forms_config')) {
 if(!pdo_fieldexists('sudu8_page_forms_config',  'wechat_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forms_config')." ADD `wechat_i` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_forms_config')) {
 if(!pdo_fieldexists('sudu8_page_forms_config',  'address_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forms_config')." ADD `address_i` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_forms_config')) {
 if(!pdo_fieldexists('sudu8_page_forms_config',  'date_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forms_config')." ADD `date_i` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_forms_config')) {
 if(!pdo_fieldexists('sudu8_page_forms_config',  'time_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forms_config')." ADD `time_i` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_forms_config')) {
 if(!pdo_fieldexists('sudu8_page_forms_config',  'single_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forms_config')." ADD `single_i` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_forms_config')) {
 if(!pdo_fieldexists('sudu8_page_forms_config',  'checkbox_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forms_config')." ADD `checkbox_i` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_forms_config')) {
 if(!pdo_fieldexists('sudu8_page_forms_config',  'content_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forms_config')." ADD `content_i` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_forms_config')) {
...
if(pdo_tableexists('sudu8_page_formt')) {
 if(!pdo_fieldexists('sudu8_page_formt',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_formt')." ADD `flag` int(1) NOT NULL;");
 }
}
...
if(pdo_tableexists('sudu8_page_forum_collection')) {
 if(!pdo_fieldexists('sudu8_page_forum_collection',  'collection')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_collection')." ADD `collection` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_forum_collection')) {
...
if(pdo_tableexists('sudu8_page_forum_func')) {
 if(!pdo_fieldexists('sudu8_page_forum_func',  'num')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_func')." ADD `num` int(11) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_forum_func')) {
 if(!pdo_fieldexists('sudu8_page_forum_func',  'status')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_func')." ADD `status` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1启用 2不启用';");
 }
}
if(pdo_tableexists('sudu8_page_forum_func')) {
...
if(pdo_tableexists('sudu8_page_forum_likes')) {
 if(!pdo_fieldexists('sudu8_page_forum_likes',  'likes')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_likes')." ADD `likes` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1点赞 2不点赞';");
 }
}
if(pdo_tableexists('sudu8_page_forum_likes')) {
...
if(pdo_tableexists('sudu8_page_forum_order')) {
 if(!pdo_fieldexists('sudu8_page_forum_order',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_order')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '1已支付  2未支付';");
 }
}
if(pdo_tableexists('sudu8_page_forum_order')) {
...
if(pdo_tableexists('sudu8_page_forum_release')) {
 if(!pdo_fieldexists('sudu8_page_forum_release',  'hot')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_release')." ADD `hot` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '是否推荐（1推荐 2不推荐）';");
 }
}
if(pdo_tableexists('sudu8_page_forum_release')) {
...
if(pdo_tableexists('sudu8_page_forum_release')) {
 if(!pdo_fieldexists('sudu8_page_forum_release',  'stick')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_release')." ADD `stick` int(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '1置顶 2不置顶';");
 }
}
if(pdo_tableexists('sudu8_page_forum_release')) {
...
if(pdo_tableexists('sudu8_page_forum_set')) {
 if(!pdo_fieldexists('sudu8_page_forum_set',  'release_money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_set')." ADD `release_money` decimal(5,2) NOT NULL DEFAULT NULL DEFAULT '0.00';");
 }
}
if(pdo_tableexists('sudu8_page_forum_set')) {
 if(!pdo_fieldexists('sudu8_page_forum_set',  'stick_money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_set')." ADD `stick_money` decimal(5,2) NOT NULL DEFAULT NULL DEFAULT '10.00';");
 }
}
if(pdo_tableexists('sudu8_page_forum_stick')) {
 if(!pdo_fieldexists('sudu8_page_forum_stick',  'id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_forum_stick')." ADD `id` int(11) NOT NULL  AUTO_INCREMENT;");
 }
}
if(pdo_tableexists('sudu8_page_forum_stick')) {
...
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'fx_cj')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `fx_cj` int(1) NOT NULL DEFAULT NULL DEFAULT '4'  COMMENT '1一级2二级3三级4不启用';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'sxj_gx')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `sxj_gx` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1点击分享2首次下单3首次付款';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'fxs_sz')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `fxs_sz` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1无条件2申请3消费次数4消费金额5购买商品';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'fxs_sz_val')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `fxs_sz_val` varchar(255) NOT NULL   COMMENT '分销商规则值';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
...
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'one_bili')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `one_bili` int(11) NOT NULL   COMMENT '一级比例';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'two_bili')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `two_bili` int(11) NOT NULL   COMMENT '二级比例';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'three_bili')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `three_bili` int(11) NOT NULL   COMMENT '三级比例';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'txmoney')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `txmoney` float() NOT NULL DEFAULT NULL DEFAULT '10';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
...
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'miaos')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `miaos` int(11) NOT NULL DEFAULT NULL DEFAULT '5';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'fx_name')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `fx_name` varchar(255) NOT NULL DEFAULT NULL DEFAULT '分销商';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
...
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'fxs_name')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `fxs_name` varchar(255) NOT NULL DEFAULT NULL DEFAULT '分销商';");
 }
}
if(pdo_tableexists('sudu8_page_fx_gz')) {
 if(!pdo_fieldexists('sudu8_page_fx_gz',  'tx_type')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_gz')." ADD `tx_type` varchar(32)  DEFAULT NULL DEFAULT '1,2,3';");
 }
}
...
if(pdo_tableexists('sudu8_page_fx_ls')) {
 if(!pdo_fieldexists('sudu8_page_fx_ls',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_ls')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1待分成2已分成3取消分成';");
 }
}
...
if(pdo_tableexists('sudu8_page_fx_sq')) {
 if(!pdo_fieldexists('sudu8_page_fx_sq',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_sq')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1申请中2已通过3不通过';");
 }
}
if(pdo_tableexists('sudu8_page_fx_sq')) {
 if(!pdo_fieldexists('sudu8_page_fx_sq',  'formid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_sq')." ADD `formid` varchar(255);");
 }
}
...
if(pdo_tableexists('sudu8_page_fx_tx')) {
 if(!pdo_fieldexists('sudu8_page_fx_tx',  'types')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_tx')." ADD `types` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1余额2微信3支付宝';");
 }
}
if(pdo_tableexists('sudu8_page_fx_tx')) {
...
if(pdo_tableexists('sudu8_page_fx_tx')) {
 if(!pdo_fieldexists('sudu8_page_fx_tx',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_tx')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1申请中2已通过3已拒绝';");
 }
}
if(pdo_tableexists('sudu8_page_fx_tx')) {
 if(!pdo_fieldexists('sudu8_page_fx_tx',  'txtime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_fx_tx')." ADD `txtime` int(11) NOT NULL;");
 }
}
...
if(pdo_tableexists('sudu8_page_lottery_activity')) {
 if(!pdo_fieldexists('sudu8_page_lottery_activity',  'participate')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_lottery_activity')." ADD `participate` int(11) NOT NULL   COMMENT '参与人数';");
 }
}
if(pdo_tableexists('sudu8_page_lottery_activity')) {
 if(!pdo_fieldexists('sudu8_page_lottery_activity',  'win')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_lottery_activity')." ADD `win` int(11) NOT NULL   COMMENT '获奖人数';");
 }
}
if(pdo_tableexists('sudu8_page_lottery_activity')) {
 if(!pdo_fieldexists('sudu8_page_lottery_activity',  'browse')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_lottery_activity')." ADD `browse` int(11) NOT NULL   COMMENT '浏览量';");
 }
}
if(pdo_tableexists('sudu8_page_lottery_activity')) {
 if(!pdo_fieldexists('sudu8_page_lottery_activity',  'share')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_lottery_activity')." ADD `share` int(11) NOT NULL   COMMENT '分享量';");
 }
}
if(pdo_tableexists('sudu8_page_lottery_activity')) {
...
if(pdo_tableexists('sudu8_page_mauth')) {
 if(!pdo_fieldexists('sudu8_page_mauth',  'gid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_mauth')." ADD `gid` int(10);");
 }
}
...
if(pdo_tableexists('sudu8_page_mcategory')) {
 if(!pdo_fieldexists('sudu8_page_mcategory',  'opt')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_mcategory')." ADD `opt` varchar(32) NOT NULL DEFAULT NULL DEFAULT 'wb-display';");
 }
}
if(pdo_tableexists('sudu8_page_mcategory')) {
 if(!pdo_fieldexists('sudu8_page_mcategory',  'icon')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_mcategory')." ADD `icon` varchar(32) NOT NULL DEFAULT NULL DEFAULT 'wb-dashboard';");
 }
}
if(pdo_tableexists('sudu8_page_mcategory')) {
 if(!pdo_fieldexists('sudu8_page_mcategory',  'type')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_mcategory')." ADD `type` int(1) NOT NULL   COMMENT '节点还是栏目';");
 }
}
if(pdo_tableexists('sudu8_page_mcategory')) {
 if(!pdo_fieldexists('sudu8_page_mcategory',  'stat')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_mcategory')." ADD `stat` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '是否显示';");
 }
}
...
if(pdo_tableexists('sudu8_page_multicate')) {
 if(!pdo_fieldexists('sudu8_page_multicate',  'statue')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_multicate')." ADD `statue` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '多栏目状态';");
 }
}
if(pdo_tableexists('sudu8_page_multicate')) {
...
if(pdo_tableexists('sudu8_page_multicate')) {
 if(!pdo_fieldexists('sudu8_page_multicate',  'psize')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_multicate')." ADD `psize` int(11)  DEFAULT NULL DEFAULT '10';");
 }
}
...
if(pdo_tableexists('sudu8_page_multicates')) {
 if(!pdo_fieldexists('sudu8_page_multicates',  'sort')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_multicates')." ADD `sort` int(5) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_multicates')) {
 if(!pdo_fieldexists('sudu8_page_multicates',  'status')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_multicates')." ADD `status` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_multicates')) {
...
if(pdo_tableexists('sudu8_page_multicates')) {
 if(!pdo_fieldexists('sudu8_page_multicates',  'pid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_multicates')." ADD `pid` int(5) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_multicates')) {
...
if(pdo_tableexists('sudu8_page_navlist')) {
 if(!pdo_fieldexists('sudu8_page_navlist',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_navlist')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_navlist')) {
...
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `flag` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_order')) {
...
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'reback')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `reback` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'is_more')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `is_more` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_order')) {
...
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'pay_price')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `pay_price` float() NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'dkscore')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `dkscore` float() NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_order')) {
...
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'formid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `formid` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_order')) {
...
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'tsid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `tsid` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_order')) {
...
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'appoint_date')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `appoint_date` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_order')) {
...
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'qx_formid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `qx_formid` varchar(255);");
 }
}
if(pdo_tableexists('sudu8_page_order')) {
 if(!pdo_fieldexists('sudu8_page_order',  'yhInfo')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_order')." ADD `yhInfo` varchar(255);");
 }
}
...
if(pdo_tableexists('sudu8_page_p_s_base')) {
 if(!pdo_fieldexists('sudu8_page_p_s_base',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_p_s_base')." ADD `flag` int(1) NOT NULL;");
 }
}
...
if(pdo_tableexists('sudu8_page_p_s_reply')) {
 if(!pdo_fieldexists('sudu8_page_p_s_reply',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_p_s_reply')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1开启 2不开启';");
 }
}
...
if(pdo_tableexists('sudu8_page_pro_score_get')) {
 if(!pdo_fieldexists('sudu8_page_pro_score_get',  'score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pro_score_get')." ADD `score` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pro_score_get')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'label_2')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `label_2` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'pro_flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `pro_flag` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'pro_kc')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `pro_kc` int(11) NOT NULL DEFAULT NULL DEFAULT '-1';");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'pro_xz')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `pro_xz` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'sale_tnum')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `sale_tnum` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'sale_time')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `sale_time` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'pro_flag_tel')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `pro_flag_tel` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'pro_flag_data')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `pro_flag_data` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'pro_flag_time')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `pro_flag_time` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'pro_flag_ding')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `pro_flag_ding` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'is_more')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `is_more` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'pro_flag_add')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `pro_flag_add` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'formset')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `formset` int(20) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'is_score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `is_score` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'score_num')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `score_num` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'share_type')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `share_type` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1个人2仅群3个人加群';");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'share_score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `share_score` varchar(255) NOT NULL   COMMENT '分享积分';");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'share_num')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `share_num` int(11) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '分享限制次数';");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'share_gz')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `share_gz` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1公共规则2自身规则';");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'comment')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `comment` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '评论功能 1开启 2不开启';");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'multi')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `multi` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'get_share_gz')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `get_share_gz` int(1) NOT NULL DEFAULT NULL DEFAULT '2';");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'get_share_score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `get_share_score` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  ' get_share_num')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD ` get_share_num` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'get_share_num')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'kuaidi')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `kuaidi` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'sale_end_time')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `sale_end_time` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'scoreback')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `scoreback` varchar(20);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'tableis')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `tableis` int(1);");
 }
}
if(pdo_tableexists('sudu8_page_products')) {
...
if(pdo_tableexists('sudu8_page_products')) {
 if(!pdo_fieldexists('sudu8_page_products',  'is_sale')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_products')." ADD `is_sale` int(2);");
 }
}
...
if(pdo_tableexists('sudu8_page_pt_gz')) {
 if(!pdo_fieldexists('sudu8_page_pt_gz',  'types')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_gz')." ADD `types` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_pt_gz')) {
 if(!pdo_fieldexists('sudu8_page_pt_gz',  'is_score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_gz')." ADD `is_score` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1不启用 2启用【启用积分抵扣】';");
 }
}
if(pdo_tableexists('sudu8_page_pt_gz')) {
 if(!pdo_fieldexists('sudu8_page_pt_gz',  'is_tuanz')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_gz')." ADD `is_tuanz` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1不启用2启用【启用团长优惠】';");
 }
}
if(pdo_tableexists('sudu8_page_pt_gz')) {
 if(!pdo_fieldexists('sudu8_page_pt_gz',  'is_pt')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_gz')." ADD `is_pt` int(1) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '1不启用2启用【是否自动成团】';");
 }
}
if(pdo_tableexists('sudu8_page_pt_gz')) {
 if(!pdo_fieldexists('sudu8_page_pt_gz',  'pt_time')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_gz')." ADD `pt_time` int(11) NOT NULL DEFAULT NULL DEFAULT '24'  COMMENT '成团时间';");
 }
}
if(pdo_tableexists('sudu8_page_pt_gz')) {
 if(!pdo_fieldexists('sudu8_page_pt_gz',  'fahuo')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_gz')." ADD `fahuo` int(11) NOT NULL DEFAULT NULL DEFAULT '7'  COMMENT '自动发货';");
 }
}
if(pdo_tableexists('sudu8_page_pt_gz')) {
...
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'price')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `price` float() NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_order')) {
...
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'coupon')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `coupon` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'jf')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `jf` varchar(255) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'address')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `address` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_order')) {
...
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'hxtime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `hxtime` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'nav')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `nav` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_pt_order')) {
...
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `flag` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'types')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `types` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1拼团2立即购买';");
 }
}
if(pdo_tableexists('sudu8_page_pt_order')) {
...
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'ck')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `ck` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1开团2参团';");
 }
}
if(pdo_tableexists('sudu8_page_pt_order')) {
 if(!pdo_fieldexists('sudu8_page_pt_order',  'jqr')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_order')." ADD `jqr` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1买家2机器人';");
 }
}
...
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'type_x')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `type_x` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'type_y')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `type_y` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'type_i')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `type_i` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
...
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'price')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `price` float() NOT NULL   COMMENT '拼团价[显示用，一般设置最低]';");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'mark_price')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `mark_price` float() NOT NULL   COMMENT '单买价[显示用]';");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
...
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'types')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `types` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '拼团类型1单层团2阶梯团';");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
...
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'pt_min')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `pt_min` int(11) NOT NULL DEFAULT NULL DEFAULT '2'  COMMENT '拼团最小人数';");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'pt_max')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `pt_max` int(11) NOT NULL DEFAULT NULL DEFAULT '5'  COMMENT '拼团最大人数';");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
...
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'xsl')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `xsl` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'tz_yh')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `tz_yh` int(11) NOT NULL DEFAULT NULL DEFAULT '10';");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
 if(!pdo_fieldexists('sudu8_page_pt_pro',  'kuaidi')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_pro')." ADD `kuaidi` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_pt_pro')) {
...
if(pdo_tableexists('sudu8_page_pt_share')) {
 if(!pdo_fieldexists('sudu8_page_pt_share',  'creattime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_share')." ADD `creattime` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_pt_share')) {
 if(!pdo_fieldexists('sudu8_page_pt_share',  'join_count')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_share')." ADD `join_count` int(11) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_pt_share')) {
 if(!pdo_fieldexists('sudu8_page_pt_share',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_pt_share')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1正在进行2已完成3已过期';");
 }
}
...
if(pdo_tableexists('sudu8_page_recharge')) {
 if(!pdo_fieldexists('sudu8_page_recharge',  'money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_recharge')." ADD `money` varchar(255) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_recharge')) {
 if(!pdo_fieldexists('sudu8_page_recharge',  'getmoney')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_recharge')." ADD `getmoney` varchar(255) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_recharge')) {
 if(!pdo_fieldexists('sudu8_page_recharge',  'getscore')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_recharge')." ADD `getscore` varchar(255) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_recharge')) {
 if(!pdo_fieldexists('sudu8_page_recharge',  'getcoupon')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_recharge')." ADD `getcoupon` int(11) NOT NULL;");
 }
}
...
if(pdo_tableexists('sudu8_page_rechargeconf')) {
 if(!pdo_fieldexists('sudu8_page_rechargeconf',  'scroe')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_rechargeconf')." ADD `scroe` varchar(255) NOT NULL DEFAULT NULL DEFAULT '100';");
 }
}
if(pdo_tableexists('sudu8_page_rechargeconf')) {
 if(!pdo_fieldexists('sudu8_page_rechargeconf',  'money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_rechargeconf')." ADD `money` varchar(255) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_rechargeconf')) {
 if(!pdo_fieldexists('sudu8_page_rechargeconf',  'title')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_rechargeconf')." ADD `title` varchar(50) NOT NULL DEFAULT NULL DEFAULT '充值有礼';");
 }
}
if(pdo_tableexists('sudu8_page_rechargeconf')) {
 if(!pdo_fieldexists('sudu8_page_rechargeconf',  'score_shoppay')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_rechargeconf')." ADD `score_shoppay` int(11) NOT NULL   COMMENT '店内最大抵扣积分';");
 }
}
if(pdo_tableexists('sudu8_page_rechargeconf')) {
 if(!pdo_fieldexists('sudu8_page_rechargeconf',  'copyright_appid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_rechargeconf')." ADD `copyright_appid` varchar(255);");
 }
}
if(pdo_tableexists('sudu8_page_rechargeconf')) {
 if(!pdo_fieldexists('sudu8_page_rechargeconf',  'copyright_page')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_rechargeconf')." ADD `copyright_page` varchar(255);");
 }
}
...
if(pdo_tableexists('sudu8_page_score_get')) {
 if(!pdo_fieldexists('sudu8_page_score_get',  'score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_score_get')." ADD `score` float() NOT NULL   COMMENT '积分数';");
 }
}
if(pdo_tableexists('sudu8_page_score_get')) {
...
if(pdo_tableexists('sudu8_page_score_order')) {
 if(!pdo_fieldexists('sudu8_page_score_order',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_score_order')." ADD `flag` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_score_order')) {
 if(!pdo_fieldexists('sudu8_page_score_order',  'custime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_score_order')." ADD `custime` int(11) NOT NULL;");
 }
}
...
if(pdo_tableexists('sudu8_page_score_shop')) {
 if(!pdo_fieldexists('sudu8_page_score_shop',  'buy_type')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_score_shop')." ADD `buy_type` varchar(255) NOT NULL DEFAULT NULL DEFAULT '兑换';");
 }
}
if(pdo_tableexists('sudu8_page_score_shop')) {
...
if(pdo_tableexists('sudu8_page_score_shop')) {
 if(!pdo_fieldexists('sudu8_page_score_shop',  'pro_kc')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_score_shop')." ADD `pro_kc` int(11) NOT NULL DEFAULT NULL DEFAULT '-1';");
 }
}
if(pdo_tableexists('sudu8_page_score_shop')) {
 if(!pdo_fieldexists('sudu8_page_score_shop',  'sale_tnum')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_score_shop')." ADD `sale_tnum` int(22) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_score_shop')) {
...
if(pdo_tableexists('sudu8_page_score_shop')) {
 if(!pdo_fieldexists('sudu8_page_score_shop',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_score_shop')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
...
if(pdo_tableexists('sudu8_page_share_img')) {
 if(!pdo_fieldexists('sudu8_page_share_img',  'pid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_share_img')." ADD `pid` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_share_img')) {
...
if(pdo_tableexists('sudu8_page_shops_cate')) {
 if(!pdo_fieldexists('sudu8_page_shops_cate',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_cate')." ADD `flag` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
...
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'buy_type')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `buy_type` int(1) NOT NULL   COMMENT '0购买1预定';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'hot')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `hot` int(1) NOT NULL   COMMENT '0不推荐1推荐';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'pageview')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `pageview` int(11) NOT NULL   COMMENT '访问量';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'vsales')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `vsales` int(11) NOT NULL   COMMENT '虚拟销量';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'rsales')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `rsales` int(11) NOT NULL   COMMENT '真实销量';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'sellprice')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `sellprice` float(10,2) NOT NULL DEFAULT NULL DEFAULT '0.00'  COMMENT '售价';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'marketprice')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `marketprice` float(10,2) NOT NULL DEFAULT NULL DEFAULT '0.00'  COMMENT '市场价';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'storage')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `storage` int(11) NOT NULL   COMMENT '库存量';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
...
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'num')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `num` int(11) NOT NULL   COMMENT '排序越大越靠前';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
...
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `flag` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '0下架1上架';");
 }
}
if(pdo_tableexists('sudu8_page_shops_goods')) {
 if(!pdo_fieldexists('sudu8_page_shops_goods',  'status')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_goods')." ADD `status` int(1) NOT NULL   COMMENT '0未审核1已审核';");
 }
}
...
if(pdo_tableexists('sudu8_page_shops_set')) {
 if(!pdo_fieldexists('sudu8_page_shops_set',  'apply')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_set')." ADD `apply` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '0不需要审核1需要';");
 }
}
if(pdo_tableexists('sudu8_page_shops_set')) {
 if(!pdo_fieldexists('sudu8_page_shops_set',  'goods')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_set')." ADD `goods` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '商品0不需审核1需要';");
 }
}
if(pdo_tableexists('sudu8_page_shops_set')) {
 if(!pdo_fieldexists('sudu8_page_shops_set',  'withdraw')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_set')." ADD `withdraw` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '提现0不需要审核1需要';");
 }
}
if(pdo_tableexists('sudu8_page_shops_set')) {
 if(!pdo_fieldexists('sudu8_page_shops_set',  'minimum')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_set')." ADD `minimum` float(10,2) NOT NULL DEFAULT NULL DEFAULT '0.00'  COMMENT '最低提现金额';");
 }
}
if(pdo_tableexists('sudu8_page_shops_set')) {
...
if(pdo_tableexists('sudu8_page_shops_set')) {
 if(!pdo_fieldexists('sudu8_page_shops_set',  'tjnum')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_set')." ADD `tjnum` int(11) NOT NULL DEFAULT NULL DEFAULT '6'  COMMENT '推荐数';");
 }
}
if(pdo_tableexists('sudu8_page_shops_set')) {
 if(!pdo_fieldexists('sudu8_page_shops_set',  'num')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_set')." ADD `num` int(11) NOT NULL DEFAULT NULL DEFAULT '6'  COMMENT '默认数';");
 }
}
...
if(pdo_tableexists('sudu8_page_shops_shop')) {
 if(!pdo_fieldexists('sudu8_page_shops_shop',  'username')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_shop')." ADD `username` varchar(50) NOT NULL DEFAULT NULL DEFAULT 'admin'  COMMENT '登录名';");
 }
}
if(pdo_tableexists('sudu8_page_shops_shop')) {
 if(!pdo_fieldexists('sudu8_page_shops_shop',  'password')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_shop')." ADD `password` varchar(50) NOT NULL DEFAULT NULL DEFAULT '12345'  COMMENT '密码';");
 }
}
if(pdo_tableexists('sudu8_page_shops_shop')) {
 if(!pdo_fieldexists('sudu8_page_shops_shop',  'tixian')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_shop')." ADD `tixian` float(10,2) NOT NULL DEFAULT NULL DEFAULT '0.00'  COMMENT '可提现金额';");
 }
}
if(pdo_tableexists('sudu8_page_shops_shop')) {
...
if(pdo_tableexists('sudu8_page_shops_shop')) {
 if(!pdo_fieldexists('sudu8_page_shops_shop',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_shop')." ADD `flag` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '状态0下架1上架';");
 }
}
if(pdo_tableexists('sudu8_page_shops_shop')) {
 if(!pdo_fieldexists('sudu8_page_shops_shop',  'hot')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_shop')." ADD `hot` tinyint(1) NOT NULL   COMMENT '0不推荐，1推荐';");
 }
}
if(pdo_tableexists('sudu8_page_shops_shop')) {
 if(!pdo_fieldexists('sudu8_page_shops_shop',  'authenticate')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_shop')." ADD `authenticate` tinyint(1) NOT NULL   COMMENT '是否已认证0否1是';");
 }
}
if(pdo_tableexists('sudu8_page_shops_shop')) {
...
if(pdo_tableexists('sudu8_page_shops_shop')) {
 if(!pdo_fieldexists('sudu8_page_shops_shop',  'num')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_shop')." ADD `num` int(11) NOT NULL   COMMENT '排序越大越靠前';");
 }
}
if(pdo_tableexists('sudu8_page_shops_shop')) {
...
if(pdo_tableexists('sudu8_page_shops_shop')) {
 if(!pdo_fieldexists('sudu8_page_shops_shop',  'status')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_shop')." ADD `status` int(1) NOT NULL   COMMENT '0未审核1已审核';");
 }
}
...
if(pdo_tableexists('sudu8_page_shops_tixian')) {
 if(!pdo_fieldexists('sudu8_page_shops_tixian',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_shops_tixian')." ADD `flag` int(1) NOT NULL   COMMENT '0申请中1已通过2已拒绝';");
 }
}
if(pdo_tableexists('sudu8_page_shops_tixian')) {
...
if(pdo_tableexists('sudu8_page_sign_con')) {
 if(!pdo_fieldexists('sudu8_page_sign_con',  'score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_sign_con')." ADD `score` varchar(20) NOT NULL DEFAULT NULL DEFAULT '10/20';");
 }
}
if(pdo_tableexists('sudu8_page_sign_con')) {
 if(!pdo_fieldexists('sudu8_page_sign_con',  'max_score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_sign_con')." ADD `max_score` int(11) NOT NULL DEFAULT NULL DEFAULT '100000';");
 }
}
...
if(pdo_tableexists('sudu8_page_sign_lx')) {
 if(!pdo_fieldexists('sudu8_page_sign_lx',  'count')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_sign_lx')." ADD `count` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_sign_lx')) {
 if(!pdo_fieldexists('sudu8_page_sign_lx',  'max_count')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_sign_lx')." ADD `max_count` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_sign_lx')) {
 if(!pdo_fieldexists('sudu8_page_sign_lx',  'all_count')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_sign_lx')." ADD `all_count` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `id` int(11) NOT NULL  AUTO_INCREMENT;");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'uniacid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `uniacid` int(11)    COMMENT '小程序ID';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'realname')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `realname` varchar(255) NOT NULL   COMMENT '真实姓名';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'mobile')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `mobile` varchar(11) NOT NULL   COMMENT '手机号码';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'wxnumber')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `wxnumber` varchar(100)    COMMENT '微信号码';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'email')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `email` varchar(50) NOT NULL   COMMENT '邮箱';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'province')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `province` varchar(100)    COMMENT '所属省';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'proid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `proid` int(10) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'city')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `city` varchar(100)    COMMENT '所属城市';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'cityid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `cityid` int(10) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'area')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `area` varchar(100)    COMMENT '所属区/市/县';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'areaid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `areaid` int(10) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'address')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `address` varchar(100)    COMMENT '详细地址';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'title')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `title` varchar(50)    COMMENT '头衔';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'job')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `job` varchar(50)    COMMENT '职务';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'pic')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `pic` varchar(255)    COMMENT '照片';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'contract')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `contract` int(10)    COMMENT '签约状态 0-未签约  1-已签约  2-待续约';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'auth')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `auth` int(10)    COMMENT '认证状态  0-待认证, 1-已认证';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `score` float(2,1)  DEFAULT NULL DEFAULT '0.0'  COMMENT '评分  0-5星';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'visit')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `visit` int(10)    COMMENT '访问量';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'zan')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `zan` int(10)    COMMENT '点赞量';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'forward')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `forward` int(10)    COMMENT '转发量';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'expand')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `expand` varchar(255)    COMMENT '拓展内容';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'price')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `price` int(10)    COMMENT '工时费';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'descp')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `descp` text()    COMMENT '介绍';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'voice')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `voice` varchar(255)    COMMENT '音频介绍';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'autovoice')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `autovoice` int(10) NOT NULL   COMMENT '是否自动播放语音';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'qrcode')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `qrcode` varchar(255)    COMMENT '生成的二维码图片';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'bqrcode')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `bqrcode` varchar(255)    COMMENT '后台生成二维码';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'company')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `company` varchar(255)    COMMENT '所属公司';");
 }
}
if(pdo_tableexists('sudu8_page_staff')) {
 if(!pdo_fieldexists('sudu8_page_staff',  'visitor')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff')." ADD `visitor` varchar(255);");
 }
}
if(pdo_tableexists('sudu8_page_staff_record')) {
 if(!pdo_fieldexists('sudu8_page_staff_record',  'id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_record')." ADD `id` int(11) NOT NULL  AUTO_INCREMENT;");
 }
}
if(pdo_tableexists('sudu8_page_staff_record')) {
 if(!pdo_fieldexists('sudu8_page_staff_record',  'uniacid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_record')." ADD `uniacid` int(11)    COMMENT '小程序ID';");
 }
}
if(pdo_tableexists('sudu8_page_staff_record')) {
 if(!pdo_fieldexists('sudu8_page_staff_record',  'operid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_record')." ADD `operid` int(11)    COMMENT '操作人ID';");
 }
}
if(pdo_tableexists('sudu8_page_staff_record')) {
 if(!pdo_fieldexists('sudu8_page_staff_record',  'readid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_record')." ADD `readid` int(11)    COMMENT '查看人ID';");
 }
}
if(pdo_tableexists('sudu8_page_staff_record')) {
 if(!pdo_fieldexists('sudu8_page_staff_record',  'staffid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_record')." ADD `staffid` int(11)    COMMENT '员工ID';");
 }
}
if(pdo_tableexists('sudu8_page_staff_record')) {
 if(!pdo_fieldexists('sudu8_page_staff_record',  'type')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_record')." ADD `type` varchar(50)    COMMENT '类型 分享还是保存';");
 }
}
if(pdo_tableexists('sudu8_page_staff_record')) {
 if(!pdo_fieldexists('sudu8_page_staff_record',  'score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_record')." ADD `score` int(10) NOT NULL   COMMENT '积分';");
 }
}
if(pdo_tableexists('sudu8_page_staff_record')) {
 if(!pdo_fieldexists('sudu8_page_staff_record',  'prize')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_record')." ADD `prize` int(10) NOT NULL   COMMENT '抽奖次数';");
 }
}
if(pdo_tableexists('sudu8_page_staff_record')) {
 if(!pdo_fieldexists('sudu8_page_staff_record',  'createtime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_record')." ADD `createtime` int(11) NOT NULL   COMMENT '操作时间';");
 }
}
if(pdo_tableexists('sudu8_page_staff_zans')) {
 if(!pdo_fieldexists('sudu8_page_staff_zans',  'id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_zans')." ADD `id` int(11) NOT NULL  AUTO_INCREMENT;");
 }
}
if(pdo_tableexists('sudu8_page_staff_zans')) {
 if(!pdo_fieldexists('sudu8_page_staff_zans',  'uid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_zans')." ADD `uid` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_staff_zans')) {
 if(!pdo_fieldexists('sudu8_page_staff_zans',  'uniacid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_zans')." ADD `uniacid` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_staff_zans')) {
 if(!pdo_fieldexists('sudu8_page_staff_zans',  'zans')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_zans')." ADD `zans` int(10) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1点赞 0不点赞';");
 }
}
if(pdo_tableexists('sudu8_page_staff_zans')) {
 if(!pdo_fieldexists('sudu8_page_staff_zans',  'sid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_zans')." ADD `sid` int(11) NOT NULL   COMMENT '员工id';");
 }
}
if(pdo_tableexists('sudu8_page_staff_zans')) {
 if(!pdo_fieldexists('sudu8_page_staff_zans',  'createtime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staff_zans')." ADD `createtime` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `id` int(11) NOT NULL  AUTO_INCREMENT;");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'uniacid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `uniacid` int(11)    COMMENT '小程序ID';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'list_style')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `list_style` int(2) NOT NULL   COMMENT '员工列表样式';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'card_style')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `card_style` int(2) NOT NULL   COMMENT '名片样式';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'is_share')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `is_share` int(2) NOT NULL   COMMENT '是否开启分享名片规则';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'share_score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `share_score` int(10) NOT NULL   COMMENT '分享一次积分';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'share_scount')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `share_scount` int(10) NOT NULL   COMMENT '每天分享获得积分上限';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'share_prize')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `share_prize` int(10) NOT NULL   COMMENT '分享一次抽奖次数';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'share_pcount')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `share_pcount` int(10) NOT NULL   COMMENT '每天分享获得抽奖上限';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'is_save')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `is_save` int(2) NOT NULL   COMMENT '是否开启保存名片规则';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'save_score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `save_score` int(10) NOT NULL   COMMENT '保存一次积分';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'save_scount')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `save_scount` int(10) NOT NULL   COMMENT '每天保存获得积分上限';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'save_prize')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `save_prize` int(10) NOT NULL   COMMENT '保存一次抽奖次数';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'save_pcount')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `save_pcount` int(10) NOT NULL   COMMENT '每天保存获得抽奖上限';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'tabbar_t')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `tabbar_t` int(2) NOT NULL   COMMENT '是否开启底部菜单';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'tabbar_bg')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `tabbar_bg` varchar(50)    COMMENT '菜单栏背景色';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'color_bar')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `color_bar` varchar(50)    COMMENT '菜单栏横线颜色';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'tabbar_tc')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `tabbar_tc` varchar(50)    COMMENT '菜单栏文字颜色';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'tabbar_tca')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `tabbar_tca` varchar(50)    COMMENT '选中文字颜色';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'tabbar')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `tabbar` text()    COMMENT '底部菜单配置';");
 }
}
if(pdo_tableexists('sudu8_page_staffset')) {
 if(!pdo_fieldexists('sudu8_page_staffset',  'tabnum')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_staffset')." ADD `tabnum` int(2)    COMMENT '底部菜单数量';");
 }
}
...
if(pdo_tableexists('sudu8_page_storeconf')) {
 if(!pdo_fieldexists('sudu8_page_storeconf',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_storeconf')." ADD `flag` int(2) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_storeconf')) {
 if(!pdo_fieldexists('sudu8_page_storeconf',  'search')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_storeconf')." ADD `search` int(1) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_storeconf')) {
 if(!pdo_fieldexists('sudu8_page_storeconf',  'title')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_storeconf')." ADD `title` varchar(255) NOT NULL DEFAULT NULL DEFAULT '门店';");
 }
}
...
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `id` int(10) NOT NULL  AUTO_INCREMENT;");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'uniacid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `uniacid` int(10)    COMMENT '小程序ID';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
...
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'createtime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `createtime` int(11) NOT NULL   COMMENT '加入时间';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
...
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'gender')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `gender` tinyint(1)    COMMENT '性别(0:保密 1:男 2:女)';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
...
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `money` float() NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'score')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `score` float() NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `flag` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'p_p_parent_id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `p_p_parent_id` varchar(1000) NOT NULL   COMMENT '父级的父级的父级';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'p_parent_id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `p_parent_id` varchar(1000) NOT NULL   COMMENT '父级的父级';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'parent_id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `parent_id` varchar(1000) NOT NULL   COMMENT '父级';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'fxs')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `fxs` int(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '1不是分销商2分销商';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'fxstime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `fxstime` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'fx_allmoney')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `fx_allmoney` float() NOT NULL   COMMENT '分销获得过的钱';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'fx_getmoney')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `fx_getmoney` float() NOT NULL   COMMENT '分销已经提现的钱';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'fx_money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `fx_money` float() NOT NULL   COMMENT '分销商获得过的钱分销可提现钱';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'p_get_money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `p_get_money` float() NOT NULL   COMMENT '父级获得的钱';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'p_p_get_money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `p_p_get_money` float() NOT NULL   COMMENT '父父级获得的钱';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
 if(!pdo_fieldexists('sudu8_page_user',  'p_p_p_get_money')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_user')." ADD `p_p_p_get_money` float() NOT NULL   COMMENT '父父父级获得的钱';");
 }
}
if(pdo_tableexists('sudu8_page_user')) {
...
if(pdo_tableexists('sudu8_page_usergroup')) {
 if(!pdo_fieldexists('sudu8_page_usergroup',  'id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_usergroup')." ADD `id` int(11) NOT NULL  AUTO_INCREMENT;");
 }
}
if(pdo_tableexists('sudu8_page_usergroup')) {
 if(!pdo_fieldexists('sudu8_page_usergroup',  'name')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_usergroup')." ADD `name` varchar(255) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_usergroup')) {
 if(!pdo_fieldexists('sudu8_page_usergroup',  'uniacid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_usergroup')." ADD `uniacid` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_usergroup')) {
 if(!pdo_fieldexists('sudu8_page_usergroup',  'remark')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_usergroup')." ADD `remark` varchar(255) NOT NULL   COMMENT '备注';");
 }
}
if(pdo_tableexists('sudu8_page_usergroup')) {
 if(!pdo_fieldexists('sudu8_page_usergroup',  'createtime')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_usergroup')." ADD `createtime` datetime() NOT NULL;");
 }
}
...
if(pdo_tableexists('sudu8_page_video_pay')) {
 if(!pdo_fieldexists('sudu8_page_video_pay',  'type')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_video_pay')." ADD `type` int(1) NOT NULL DEFAULT NULL DEFAULT '1';");
 }
}
if(pdo_tableexists('sudu8_page_vip_apply')) {
 if(!pdo_fieldexists('sudu8_page_vip_apply',  'id')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_apply')." ADD `id` int(10) NOT NULL  AUTO_INCREMENT;");
 }
}
if(pdo_tableexists('sudu8_page_vip_apply')) {
...
if(pdo_tableexists('sudu8_page_vip_apply')) {
 if(!pdo_fieldexists('sudu8_page_vip_apply',  'uniacid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_apply')." ADD `uniacid` int(11) NOT NULL;");
 }
}
if(pdo_tableexists('sudu8_page_vip_apply')) {
...
if(pdo_tableexists('sudu8_page_vip_apply')) {
 if(!pdo_fieldexists('sudu8_page_vip_apply',  'fid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_apply')." ADD `fid` int(11) NOT NULL   COMMENT '提交表单信息id';");
 }
}
if(pdo_tableexists('sudu8_page_vip_apply')) {
...
if(pdo_tableexists('sudu8_page_vip_apply')) {
 if(!pdo_fieldexists('sudu8_page_vip_apply',  'flag')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_apply')." ADD `flag` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '3'  COMMENT '3未审核 1通过  2不通过';");
 }
}
if(pdo_tableexists('sudu8_page_vip_apply')) {
...
if(pdo_tableexists('sudu8_page_vip_config')) {
 if(!pdo_fieldexists('sudu8_page_vip_config',  'isopen')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_config')." ADD `isopen` tinyint(1) NOT NULL DEFAULT NULL DEFAULT '1'  COMMENT '会员卡0不开启1开启2强制开启';");
 }
}
if(pdo_tableexists('sudu8_page_vip_config')) {
 if(!pdo_fieldexists('sudu8_page_vip_config',  'name')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_config')." ADD `name` varchar(255) NOT NULL DEFAULT NULL DEFAULT '会员卡'  COMMENT '会员卡名称';");
 }
}
if(pdo_tableexists('sudu8_page_vip_config')) {
 if(!pdo_fieldexists('sudu8_page_vip_config',  'recharge')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_config')." ADD `recharge` tinyint(1) NOT NULL   COMMENT '充值0直接可用1开卡后可用';");
 }
}
if(pdo_tableexists('sudu8_page_vip_config')) {
 if(!pdo_fieldexists('sudu8_page_vip_config',  'coupon')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_config')." ADD `coupon` tinyint(1) NOT NULL   COMMENT '领优惠券0直接可用1开卡后可用';");
 }
}
if(pdo_tableexists('sudu8_page_vip_config')) {
 if(!pdo_fieldexists('sudu8_page_vip_config',  'sign')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_config')." ADD `sign` tinyint(1) NOT NULL   COMMENT '积分签到0直接可用1开卡后可用';");
 }
}
if(pdo_tableexists('sudu8_page_vip_config')) {
 if(!pdo_fieldexists('sudu8_page_vip_config',  'exchange')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_config')." ADD `exchange` tinyint(1) NOT NULL   COMMENT '积分兑换0直接可用1开卡后可用';");
 }
}
if(pdo_tableexists('sudu8_page_vip_config')) {
 if(!pdo_fieldexists('sudu8_page_vip_config',  'formid')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_config')." ADD `formid` int(11);");
 }
}
if(pdo_tableexists('sudu8_page_vip_config')) {
 if(!pdo_fieldexists('sudu8_page_vip_config',  'shenhe')) {
  pdo_query("ALTER TABLE ".tablename('sudu8_page_vip_config')." ADD `shenhe` int(1)  DEFAULT NULL DEFAULT '2';");
 }
}
