...
load()->func('tpl');
        ...
        if($opt == "shenhe"){
            ...
            if($val==2){
                ...
                if($sqtx['types']==2){  //支付到微信
                    ...
                    if($result){
                        ...
                        $user_fxmoney = round($user_fxmoney - $money, 2);
            ...
            if($val==3){
                ...
                message('提现 新增/修改成功!!', $this->createWebUrl('Distributionset', array('op'=>'tixian','opt'=>"display",'cateid'=>$_GPC['cateid'],'chid'=>$_GPC['chid'])), 'success');
            }
