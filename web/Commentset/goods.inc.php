<?php
    ...
    if ($opt == 'display'){
        $_W['page']['title'] = '产品管理';
        $total = pdo_fetchcolumn("SELECT count(*) FROM ".tablename('sudu8_page_products')."as i left join" .tablename('sudu8_page_cate')." as c on i.cid = c.id WHERE i.uniacid = ".$uniacid." and i.type ='showPro' and i.is_more = 0");
